            ...
            <div className="container mx-auto px-6 text-center space-y-6 md:space-y-8 lg:space-y-10">
               <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 lg:gap-7 items-center justify-center">
                    <p className="md:col-span-6 col-span-1 text-sm md:text-lg lg:text-xl mb-6 text-justify ">
                    ...
                    <div className="relative md:col-span-6 col-span-1 p-4 md:p-8 lg:p-10">
                        ...
                        <div className="order-1 lg:order-2 animate-fade-in-up text-start">
                            <CoderProfileCard />
                        </div>
                    </div>
                </div>
